...
const ViewUser = () => {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      ...
      // If the current user is an admin and is viewing another user's profile, hide logout button
      ...
      try {
        ...
        // Show/hide the logout button based on the comparison
        setLoading(false);
      } catch (err: any) {
      ...
      <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-4 sm:space-y-0">
          <img
            ...
            alt={user.name}
            className="w-24 h-24 rounded-full object-cover border-4 border-indigo-500 flex-shrink-0"
          />
